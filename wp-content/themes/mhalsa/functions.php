...
define( 'MHALSA_VERSION', '1.0.2' );

if ( ! function_exists( 'mhalsa_setup' ) ) {
	add_action( 'after_setup_theme', 'mhalsa_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function mhalsa_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'mhalsa' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'mhalsa' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in mhalsa_smart_content_width()
		 */
...
define('MHALSA_THEME_URL','https://wpkoi.com/mhalsa-wpkoi-wordpress-theme/');
define('MHALSA_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('MHALSA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('MHALSA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/mhalsa/reviews/?filter=5');
define('MHALSA_DOCUMENTATION','https://wpkoi.com/docs/');
define('MHALSA_FONT_AWESOME_LINK','https://fontawesome.com/icons');

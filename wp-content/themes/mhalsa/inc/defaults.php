...
if ( ! function_exists( 'mhalsa_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function mhalsa_get_defaults() {
		$mhalsa_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
			...
			'text_color' => '#41ead4',
			'link_color' => '#fdfffc',
			'link_color_hover' => '#41ead4',
			'link_color_visited' => '',
			'font_awesome_essentials' => true,
		);

		return apply_filters( 'mhalsa_option_defaults', $mhalsa_defaults );
	}
}

if ( ! function_exists( 'mhalsa_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function mhalsa_get_color_defaults() {
		$mhalsa_color_defaults = array(
			'top_bar_background_color' => '#200e57',
			'top_bar_text_color' => '#fdfffc',
			'top_bar_link_color' => '#41ead4',
			'top_bar_link_color_hover' => '#fdfffc',
			'header_background_color' => '#ea1d5f',
			'header_text_color' => '#fdfffc',
			'header_link_color' => '#fdfffc',
			'header_link_hover_color' => '#fdfffc',
			'site_title_color' => '#200e57',
			'site_tagline_color' => '#fdfffc',
			'navigation_background_color' => '#ea1d5f',
			'navigation_text_color' => '#fdfffc',
			'navigation_background_hover_color' => '',
			'navigation_text_hover_color' => '#200e57',
			'navigation_background_current_color' => '',
			'navigation_text_current_color' => '',
			'subnavigation_background_color' => '#fdfffc',
			'subnavigation_text_color' => '#200e57',
			'subnavigation_background_hover_color' => '',
			'subnavigation_text_hover_color' => '#ea1d5f',
			'subnavigation_background_current_color' => '',
			'subnavigation_text_current_color' => '',
			'fixed_side_content_background_color' => '#200e57',
			'fixed_side_content_text_color' => '#ea1d5f',
			'fixed_side_content_link_color' => '#fdfffc',
			'fixed_side_content_link_hover_color' => '#ea1d5f',
			'content_background_color' => '',
			'content_text_color' => '',
			'content_link_color' => '',
			'content_link_hover_color' => '',
			'content_title_color' => '',
			'blog_header_bg_color' => '#ea1d5f',
			'blog_header_bg_s_color' => 'rgba(255,255,255,0)',
			'blog_header_title_color' => '#fdfffc',
			'blog_header_text_color' => '#41ead4',
			'blog_header_button' => '#200e57',
			'blog_header_button_bg' => '#fdfffc',
			'blog_header_button_hover' => '#200e57',
			'blog_header_button_hover_bg' => '#41ead4',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#200e57',
			'sidebar_widget_text_color' => '#41ead4',
			'sidebar_widget_link_color' => '#fdfffc',
			'sidebar_widget_link_hover_color' => '#41ead4',
			'sidebar_widget_title_color' => '#41ead4',
			'footer_widget_background_color' => '#200e57',
			'footer_widget_text_color' => '#41ead4',
			'footer_widget_link_color' => '#fdfffc',
			'footer_widget_link_hover_color' => '#41ead4',
			'footer_widget_title_color' => '#41ead4',
			'footer_background_color' => '#200e57',
			'footer_text_color' => '#41ead4',
			'footer_link_color' => '#fdfffc',
			'footer_link_hover_color' => '#41ead4',
			...
			'form_button_background_color' => '#fdfffc',
			'form_button_background_color_hover' => '#41ead4',
			'form_button_text_color' => '#200e57',
			'form_button_text_color_hover' => '#200e57',
			'back_to_top_background_color' => 'rgba(32,14,87,0.7)',
			'back_to_top_background_color_hover' => '#200e57',
			'back_to_top_text_color' => '#fdfffc',
			'back_to_top_text_color_hover' => '#fdfffc',
		);

		return apply_filters( 'mhalsa_color_option_defaults', $mhalsa_color_defaults );
	}
}
...
if ( ! function_exists( 'mhalsa_get_default_fonts' ) ) {
	 ...
	 */
	function mhalsa_get_default_fonts( $filter = true ) {
		$mhalsa_font_defaults = array(
			'font_body' => 'Lato',
			'font_body_category' => '',
			...
			'font_blog_header_title' => 'Luckiest Guy',
			...
			'font_navigation' => 'Libre Franklin',
			...
			'font_widget_title' => 'Luckiest Guy',
		...
		if ( $filter ) {
			return apply_filters( 'mhalsa_font_option_defaults', $mhalsa_font_defaults );
		}

		return $mhalsa_font_defaults;
	}
}

if ( ! function_exists( 'mhalsa_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function mhalsa_spacing_get_defaults( $filter = true ) {
		$mhalsa_spacing_defaults = array(
			'top_bar_top' => '5',
			'top_bar_right' => '40',
			'top_bar_bottom' => '2',
			'top_bar_left' => '40',
		...
		if ( $filter ) {
			return apply_filters( 'mhalsa_spacing_option_defaults', $mhalsa_spacing_defaults );
		}

		return $mhalsa_spacing_defaults;
	}
}

if ( ! function_exists( 'mhalsa_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function mhalsa_get_default_color_palettes() {
		$palettes = array(
			'#ea1d5f',
			'#200e57',
			'#41ead4',
		...
		return apply_filters( 'mhalsa_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'mhalsa_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function mhalsa_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'mhalsa_typography_default_fonts', $fonts );
	}
}

define( 'MHALSA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Lato:100,100italic,300,300italic,regular,italic,700,700italic,900,900italic|Luckiest+Guy:regular|Libre+Franklin:100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic' );

...
if ( ! function_exists( 'mhalsa_social_bar' ) ) {
	add_action( 'mhalsa_social_bar_action', 'mhalsa_social_bar' );
	function mhalsa_social_bar() {
		$socials_facebook_url  		=  mhalsa_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  mhalsa_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  mhalsa_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  mhalsa_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  mhalsa_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  mhalsa_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  mhalsa_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  mhalsa_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  mhalsa_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  mhalsa_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  mhalsa_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  mhalsa_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  mhalsa_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  mhalsa_get_setting( 'socials_mail_url' );
	?>
